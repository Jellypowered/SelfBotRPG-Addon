...
local definitions={
 ...
 {key="adaptiveordering",label="Adaptive ordering (beta)",kind="bool",capability="ADAPTIVE_ORDERING",tip="Opt-in live-node ordering using bounded session evidence. Material and fishing yield learning is not yet enabled."},
