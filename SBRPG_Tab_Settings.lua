...
SBRPG = SBRPG or {}
local defaults={dangerscreening="0",adaptiveordering="0",enable="1",debug="0",returnhome="1",minchance="1.0",bagreserve="0",attempts="3",failedblacklist="120",emptyblacklist="120",zone="1",settledelay="1000",actiondelay="1000",bobbers="35591",uselures="1",prioritizepools="0",openwateronly="1",searchdistance="500.0",castdistance="12.0"}
local definitions={
